...
boton_iva = tk.Button(ventana, text="Calcular IVA (16%)", command=calcular_iva, bg="light pink", fg="white")
boton_iva.pack(pady=5)

boton_descuento = tk.Button(ventana, text="Calcular Descuento (10%)", command=calcular_descuento, bg="light blue", fg="white")
boton_descuento.pack(pady=5)

boton_total = tk.Button(ventana, text="Calcular Total a Pagar", command=calcular_total, bg="grey", fg="white")
